...
\title{Software Requirements Speciﬁcations voor Schedule-Generator}
...
Audience nu: Wij, de groepsleden en Ragnhild
...
% Describe the application of the software being speciﬁed, including relevant beneﬁts, objectives, and goals;
% Be consistent with similar statements in higher-level speciﬁcations (e.g., the system requirements speciﬁcation), if they exist.

Schedule generator. wat het kan en niet kan en voordelen
(zie spmp)
...
verwijs naar opdracht\\
verwijs naar standaard\\
...
...
Gebruikers krijgen een account waarop ze een gepersonaliseerd lessenrooster te zien krijgen. Ze kunnen de vakken die ze volgen aanpassen en de roosters van andere studenten bekijken. \\
Het programma houdt een database bij van de vakken en hun eigenschappen, de lokalen en hun eigenschappen en de beschikbaarheden van de verschillende professoren.\\
Het kan ook een lessenrooster opstellen dat met alle constraints rekening houdt.\\

\subsection{User characteristics}

De gebruikers zijn studenten en professoren van een universiteit en we veronderstellen dat die wel met een site kunnen werken.
...
Webinterface \\
XHTML met CSS en misschien een beetje Javascript \\
user-afhankelijke pagina die getoond wordt \\
...
\begin{itemize}
\item[.] MySQL: JDBC driver for MySQL 5.1.15 \\[-3mm]
\item[.] Tomcat \\[-3mm]
\end{itemize}
...
Schatting maken van aantal gebruikers dat tegelijkertijd aanwezig kan zijn\\
daaruit volgt de grootte van de codedatabase en snelheid.
