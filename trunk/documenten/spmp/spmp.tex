...
de deadlines voor 4 mei werden besproken: Zoals in het SPMP geschreven staat moeten de documenten een nieuwe revisie krijgen (de Revisie van het SRS was nog niet doorvoerd sinds de vorige SCRUM, daar is het dus zeer dringend)
...
Een back-of-the-envelope berekening van het geheugen dat nodig is om alles op te slaan leverde een waarde van 760MB op. (40 uur, 1000 rooms, 10000 subcourses) - Er is nog geen mogelijkheid voorzien om alle lessen 
\end{itemize}
