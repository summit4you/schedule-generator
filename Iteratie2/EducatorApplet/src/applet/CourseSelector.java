...
public class CourseSelector extends JPanel
{
	...
	public CourseSelector(Vector<Faculty> faculties,boolean emptyOnly)
	{
		super(null);
	...
	public void addCourseListener(ActionListener l)
	{
		courses.addActionListener(l);
	}
	...
	private void initPanel()
	{
		...
		psel.addProgramListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				if (p!=null)
				{
					courses.setModel(new DefaultComboBoxModel(emptyOnly?getEmptyOnly(p.getCourses()):p.getCourses()));
				}
			}
		});
	...
	private Vector<Course> getEmptyOnly(Vector<Course> courses)
	{
