...
// Define some magic strings.
		...
		$this->default_view 			= 'week';			// Default view for calendars = 'day', 'week', 'month', 'year'
		...
		$this->week_events_lines 		= '0';				// Number of lines to wrap each event title in the 'Tommorrow's events' box, 0 means display all lines.
		...
		$this->month_locations  		= 'no';			// Display location in the month view.
		$this->this_months_events 		= 'no';			// Display "This month's events" at the bottom off the month page.
		...
		$this->show_todos				= 'no';			// Show your todo list on the side of day and week view.
		$this->show_completed			= 'no';				// Show completed todos on your todo list.
