							...
							<tr>	
								<td colspan="2">
									<table width="100%" border="0" cellspacing="0" cellpadding="2" class="tfixed">
										<tr>
											<td align="left" valign="top" width="20" class="rowOff2" onmouseover="this.className='rowOn2'" onmouseout="this.className='rowOff2'" onclick="window.location.href='day.php?cal={CAL}&amp;getdate={PREV_DAY}&amp;{P_LINK}'">
												<span class="V12"><a class="psf" href="day.php?cal={CAL}&amp;getdate={PREV_DAY}&amp;{P_LINK}">&laquo;</a></span>
											</td>
											<!-- loop daysofweek on -->
											<td align="center" class="{ROW1}" onmouseover="this.className='{ROW2}'" onmouseout="this.className='{ROW3}'" onclick="window.location.href='day.php?cal={CAL}&amp;getdate={DAYLINK}&amp;{P_LINK}'">
												<span class="V9BOLD"><a class="ps3" href="day.php?cal={CAL}&amp;getdate={DAYLINK}&amp;{P_LINK}">{DAY}</a></span>
											</td>
											<!-- loop daysofweek off -->
											<td align="right" valign="top" width="20" class="rowOff" onmouseover="this.className='rowOn'" onmouseout="this.className='rowOff'" onclick="window.location.href='day.php?cal={CAL}&amp;getdate={NEXT_DAY}&amp;{P_LINK}'">
												<span class="V12"><a class="psf" href="day.php?cal={CAL}&amp;getdate={NEXT_DAY}&amp;{P_LINK}">&raquo;</a></span>
											</td>
										</tr>	
									</table>
								</td>
