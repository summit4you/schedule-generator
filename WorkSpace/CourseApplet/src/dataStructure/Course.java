...
public class Course implements Serializable,Cloneable
{
	...
	public void setResponsible(Educator responsible)
	{
		...
		{
			this.responsible.removeCourse(this);
		}
		this.responsible = responsible;
		if (this.responsible!=null)
		{
			this.responsible.addCourse(this);
		}
	}
	...
	public Object clone()
	{
		...
		c.setPrograms((Vector<Program>) programs.clone());
		c.setResponsible(responsible);
		c.setSubcourses((Vector<Subcourse>) subcourses.clone());
		c.id=null;
		return c;
	}
